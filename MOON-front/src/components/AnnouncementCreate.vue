        ...
        <div>
            ...
            <div class="flex justify-center">
                ...
                <div class=" w-full max-w-2xl p-5 m-5 border rounded-lg shadow-lg">
                    <form class="grid gap-6 mb-6 md:grid-cols-1" @submit.prevent="submit">
                        <div class="mb-3">
                            <label for="title"
                        ...
                        <div class="mb-6 flex relative space-x-4 ">
                            ...
                            <select v-model=createAnn.categoriesCategoryId class="rounded-lg border p-2" name="category">
                        ...
                        <div class="flex items-start mb-6">
                            ...
                            <label for="check" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Check to
