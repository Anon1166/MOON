...
<template>
  <div v-if="load" class="mx-auto px-6 sm:px-8 md:px-10 max-w-7xl">
    ...
    <div class="overflow-x-auto">
      <table class="ann-item  w-full border border-separate rounded-xl">
        <tr>
        ...
        <tr>
          ...
          <td class="ann-publish-date p-2" v-if="announcementDetail.publishDate !== null">{{ changeTime(announcementDetail.publishDate) }}
          </td>
          <td class="ann-publish-date p-2" v-else>-</td>
        </tr>
        <tr>
          <th class="p-2">Close Date</th>
          <td class="ann-close-date  p-2" v-if=" announcementDetail.closeDate !== null">{{ changeTime(announcementDetail.closeDate) }}</td>
    ...
    <div class="mt-6 sm:mt-8 md:mt-10 flex justify-center ann-button">
